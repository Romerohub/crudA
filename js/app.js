...
const giftUpdate = (e) => {
    ...
    cargarTabla();
    myModal.hide();
    mostrarMensaje(`Producto "${datos[index].gift}" Actualizado con éxito`, "update", mensajeActualizarDiv);
};
...
if (confirmar) {
    ...
    guardarDatosEnLocalStorage(datos);
    cargarTabla();
    mostrarMensaje(` "${giftName}" Eliminada con éxito`, 'error', mensajeEliminarDiv);
}
};
